...
De bovenstaande klassen zitten vervat binnen het \texttt{CoreEngine}-project, dat in principe voor eender welk soort spel gebruikt kan worden. Voor Hovercraft Universe is een specifieke implementatie voorzien: de \texttt{HovercraftController}, 
...
\begin{description}
	\item[Algemene architectuur] Kristof
	\item[Networking] Olivier
	\item[Scripting en AI] Dirk
	\item[Physics] Pieter-Jan, Tobias
	\item[Controls] Tobias
	\item[Geluid] Nick
	\item[GUI] Nick
	\item[3D modellen, Ogre] Kristof, Pieter-Jan
\end{description}

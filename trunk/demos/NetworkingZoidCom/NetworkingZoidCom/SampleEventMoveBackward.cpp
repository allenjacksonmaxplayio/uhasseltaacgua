...
SampleEventMoveBackward::SampleEventMoveBackward(float distance) : Event(MoveBackward), mDistance(distance) {

}

SampleEventMoveBackward::SampleEventMoveBackward() : Event(MoveForward), mDistance(0.0) {
